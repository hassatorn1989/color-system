              ...
              <Card className="border-border/70 bg-card/80 p-6 shadow-sm backdrop-blur">
                ...
                <div className="mt-4 space-y-3 text-sm text-foreground/70">
                  <p>
                    ...
                    หรือการใช้ทฤษฎีที่เกี่ยวกับการออกแบบ
                  </p>
                  <p>
                    2.
                    การใช้งานวงล้อสีและการจับคู่สีสำหรับงานผ้าทอเพื่อการออกแบบผลิตภัณฑ์
                  </p>
                  <p>
                    3. การใช้งานคลังสีผ้าทอเพื่อการคัดลอกค่าสีไปออกแบบต่อ
                    หรือเลือกเบอร์ ชื่อของสี และยี่ห้อสีชนิดต่างๆ
                    เพื่อนำไปย้อมเส้นด้าย
                  </p>
                  <p>
                  ...
                  <p className="text-red-500">
                    6.
                    ในแพลตฟอร์มที่สร้างขึ้นนี้เป็นเพียงการรวบรวมค่าสีที่ได้มาจากสีย้อมผ้ายี่ห้อต่าง ๆ ตามท้องตลาด ไม่ได้เป็นตัวแทนจำหน่าย
                    หากสนใจโปรดติดต่อทางร้านโดยตรง
                  </p>
                </div>
              </Card>
